package com.rucreativedeveloper.medicare_api_service.jwt;

import com.fasterxml.jackson.databind.ObjectMapper;

import com.rucreativedeveloper.medicare_api_service.config.JwtConfig;
import com.rucreativedeveloper.medicare_api_service.dto.request.RequestUserLoginDto;
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try {
          ...
          Authentication authentication =  new UsernamePasswordAuthenticationToken(
                    requestUserLoginDto.getUsername(),
